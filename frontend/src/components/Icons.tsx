...
export const WhatsAppIcon: React.FC<IconProps> = (p) => (
  <Svg {...p} path={<path d="M20 11.5a8.5 8.5 0 1 1-16.4 3.4L3 21l6.2-1.6A8.5 8.5 0 1 1 20 11.5zm-4.2 4.1c-.2.5-1.1 1-1.5 1.1-.4.1-.9.2-1.6 0-.4-.1-.9-.3-1.6-.6a9.8 9.8 0 0 1-3-2.1c-1-.9-1.7-2-1.8-2.1-.2-.3-.4-.7-.4-1.1 0-.4.2-.8.4-1 .2-.2.5-.5.8-.5h.6c.2 0 .4 0 .5.4.2.5.5 1.3.6 1.4.1.1.1.3 0 .5-.1.2-.2.3-.4.5l-.2.2c-.1.1-.2.2-.1.4.1.2.6 1 1.4 1.6.9.8 1.7 1.1 1.9 1.2.2.1.3.1.5 0l.6-.3c.2-.1.3-.1.5 0 .2.1 1.2.6 1.4.7.2.1.3.1.4.2.1.1.1.3 0 .5z"/>} />
);
export const ViberIcon: React.FC<IconProps> = (p) => (
  <Svg {...p} path={<path d="M18.5 2h-13A3.5 3.5 0 0 0 2 5.5v13A3.5 3.5 0 0 0 5.5 22h7.6l3.4 2-.5-3h2.5A3.5 3.5 0 0 0 22 17.5v-12A3.5 3.5 0 0 0 18.5 2zm-.6 12.8c-.2.9-1.3 1.6-2.2 1.8-1 .3-2.2.2-3.6-.4-3-1.2-5.5-3.8-6.5-6.9-.6-1.8-.2-3.2.6-3.8.2-.1.5-.2.8-.2.2 0 .5 0 .7.1.2.1.5.3.6.8.3.8.7 1.9.7 2 0 .2 0 .4-.2.6l-.5.6c-.1.1-.2.2-.1.4.3.8 1 1.8 1.8 2.6.9.9 2 .1 2.8.4.2.1.3 0 .4-.1l.6-.3c.2-.1.4-.1.6 0 .1 0 1.3.5 1.7.7.2.1.3.2.3.4 0 .2.1.4 0 .6z"/>} />
);
