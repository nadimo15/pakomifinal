                        ...
                        {cartItems.map(item => (
                            <div key={item.cartItemId} className="flex flex-col sm:flex-row items-center gap-4 border-b pb-4 last:border-b-0 last:pb-0">
                                <div className="w-24 h-24 bg-gray-100 rounded-md flex-shrink-0 flex items-center justify-center p-2">
                                     <img src={item.logoUrl || allProducts.find(p => p.id === item.productType)?.galleryImagesB64[0]} alt={item.productName} className="max-w-full max-h-full object-contain" />
                                </div>
                                ...
                                <div className="flex items-center gap-4">
                                    <QuantityInput 
                                        ...
                                        setQuantity={(newQuantity) => updateCartItemQuantity(item.cartItemId, newQuantity)}
                                        language={language}
                                    />
